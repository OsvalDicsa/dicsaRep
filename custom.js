...
//creacion dinamica de obj para carousel
$(window).enllax();
...
document.addEventListener('DOMContentLoaded', () => {
    const slides = [
        ...
        'images/slides/v1-7.jpg',
        'images/slides/v1-8.jpg',
        'images/slides/v1-9.jpg',
        'images/slides/v1-10.jpg',
        'images/slides/v1-11.jpg',
        'images/slides/v1-12.jpg',
        'images/slides/v1-13.jpg',
        'images/slides/v1-14.jpg',
    ];
    ...
    slides.forEach((slideSrc, index) => {
        ...
        indicator.setAttribute('data-target', '#simpleCarousel');
